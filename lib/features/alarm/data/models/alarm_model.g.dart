...
AlarmModel _alarmModelDeserialize(
  ...
  final object = AlarmModel(
    ...
    radius: reader.readDouble(offsets[7]),
  );
  return object;
}
...
extension AlarmModelQueryFilter
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hashCode',
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> hashCodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> radiusEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> radiusGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> radiusLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition> radiusBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AlarmModelQuerySortBy
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByRadius() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'radius', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> sortByRadiusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AlarmModelQuerySortThenBy
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.desc);
    });
  }
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByRadius() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'radius', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy> thenByRadiusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'radius', Sort.desc);
    });
  }
...
extension AlarmModelQueryWhereDistinct
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct> distinctByRadius() {
    return QueryBuilder.apply(this, (query) {
...
extension AlarmModelQueryProperty
  ...
  QueryBuilder<AlarmModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AlarmModel, double, QQueryOperations> radiusProperty() {
    return QueryBuilder.apply(this, (query) {
